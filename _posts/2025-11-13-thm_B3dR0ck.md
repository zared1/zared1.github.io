...
B3dr0ck is a vulnerable machine that falls under the medium category of TryHackMe's boot to root machines.</font></strong></center>
In this machine, Barney is setting up the ABC server but he's having some troubles using TLS/SSL certificates to encrypt and secure private data that is transmitted.</font></strong></center>
